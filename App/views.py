        ...
        if request.user.is_authenticated:
            if request.user.verificado:
                ...
                return render(request,'admin/dashboard.html',{
                    ...
                    "online":User.objects.filter(last_login__gte=ahora - timezone.timedelta(minutes=umbral_minutos), is_staff=False).count(),
                    ...
                    "data_set_citas_semanal":data_set_citas_semanal(),
                    "dataset_facturacion_semanal":dataset_facturacion_semanal()
                })
            else:
        ...
        if request.user.is_authenticated:
            ...
            try:
                ...
                if cita.clienteid:
                    ...
                    '''
                    enviar_correo(email=cita.clienteid.useris.email,asunto=Asunto,mensaje=Mensaje)
    ...
    def post(self,request):
        if request.user.is_authenticated:
            ...
            return render(request,"admin/citas_aprobadas.html",{
                ...
                "fechas_disponibles":get_fechas_disponibles(),
                "citas_aprobadas":citas_aprobadas,
                "Alerta":"No se ha aprobado la cita."
            })
